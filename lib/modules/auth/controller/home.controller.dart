...
class HomeController extends GetxController {
  ...
  void fetchUsersAndBirthdays() async {
    ...
    final mockAllUsers = [
      ...
      User(name: 'Lê Thu Linh', initials: 'LL', color: Colors.purple, dateOfBirth: DateTime(1995, 11, 27)), // Không sinh nhật
      User(name: 'Nguyễn Văn Nam', initials: 'NN', color: Colors.blue, dateOfBirth: DateTime(1985, 11, 27)),
      User(name: 'Phạm Thị Mai', initials: 'PM', color: Colors.red, dateOfBirth: DateTime(1992, 11, 27)), // Người sinh nhật thứ 3
      User(name: 'Đào Duy Anh', initials: 'ĐA', color: Colors.brown, dateOfBirth: DateTime(1993, 7, 27)), // Không sinh nhật
      User(name: 'Phạm Tiến Thành', initials: 'ĐA', color: Colors.brown, dateOfBirth: DateTime(1993, 11, 27)),
    ];
